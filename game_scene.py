...
roleCountConfig = {
    ...
    11: {"Good": 7, "Bad": 2, "Neutral": 2},
    12: {"Good": 7, "Bad": 3, "Neutral": 2},
}
...
class GameScene:
    ...
    def assign_role(self, scene_id: str):
        ...
        badPlayerList = playerList[
            roleCount["Good"] : roleCount["Good"] + roleCount["Bad"]
        ]
        neutralPlayerList = playerList[
            roleCount["Good"] + roleCount["Bad"] : roleCount["Good"]
            + roleCount["Bad"]
            + roleCount["Neutral"]
        ]
    ...
    # 召开会议
    def meeting_start(
        self, scene_id: str, alert_player_id: str, target_player_id: str | None = None
    ):
        scene = spm.get_game_scene(scene_id)
        scene["meeting"] = {
